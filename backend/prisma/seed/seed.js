 ...
 *         A JSON array with one object per contract role, each carrying the string
 *         fields: role, email, password, login_path. No literal values appear here —
 *         the platform mints them and this file is the only reader.
